...
paths["/api/v1/groups/{id}/members/{userId}"]["post"]["responses"]["201"]["content"]["application/json"] | API_ERROR
>;
...
export type MEMBERS_API = TypedResponse<
  | paths["/api/v1/groups/{groupId}/members"]["get"]["responses"]["200"]["content"]["application/json"]
